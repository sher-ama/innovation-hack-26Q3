---
name: Orchestrator
description: Orchestrates complex implementation work by planning, delegating to specialist agents, coordinating phases, and verifying results.
model: ['GPT-5.4', 'Claude Sonnet 5 (copilot)']
